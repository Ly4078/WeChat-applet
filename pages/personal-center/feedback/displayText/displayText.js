...
Page({
  data: {
    ...
    explain: [{
        id: 0,
        headline: '无法打开小程序？',
      content: ['检查网络是否正常,如果在正常网络情况下打不开,请清理小程序“享7购”再重新搜索进入，如果是新用户进入小程序首先允许授权，完成注册授权地理位置.即可打开。']
      },
      {
        id: 1,
        headline: '卡顿或界面加载慢？',
      ...
      },
      {
        ...
        content: ['根据《享7购服务范围》规定：目前只对“十堰市”、“武汉市”、“黄冈市”、“襄阳市”开放，其他城市“待开放”；进入小程序后如您在已开放城市将会自动选择对应城市，否则默认“十堰市”']
      },
      {
        id: 4,
        headline: '商家如何入驻？',
        content: ['根据《享7购服务协议》规定：所有需要入驻的商家统一下载【享7购】App进行入驻提交相关资质；快速下载【享7购】App方式：一、关注”享7购“公众号后进入公众号下载；二、在应用商店里搜索【享7商家】下载']
      },
      {
        id: 5,
        headline: '券票到哪里使用；如何核销？',
        content: [
          '享7购平台共推出：1.平台券、2.拼菜砍价券、3.限量秒杀券、4.提蟹券。',
          '平台券：全平台通用，只要是“享7购”商家且此商家有推出此优惠规则，即可核销使用，享受优化；',
      ...
      },
      {
        id: 10,
        headline: '是否支持退款？',
        content: ['享7购平台目前支持砍价以及原价购买的商品退款功能，您可以在已完成订单中申请退款，退款会在1-5天内退还到您的微信账户。拼购类的商品目前支持在开团失败后，将在1-3小时内退还到您的微信账户，开团成功后无法退款。']
      },
      {
        id: 11,
        headline: '在哪里查看我的优惠券？',
      ...
      },
      {
        ...
        // content: '1.金币是什么？金币是用户在享7购平台，通过砍价、购买等行为获得的奖励，目前仅限于在享7购平台使用；2.如何获得金币 ? a) 使用优惠劵b) 发起砍价并成功购买 c) 帮好友砍价；3.如何使用金币 ? 金币可在享7平台商城中兑换商品 a）兑换实物商品邮费到付 b）兑换时请仔细核对收货信息，商品一经兑换，不支持收货信息修改，不支持退货、提现等 c）凡兑换的实物类奖品将在15个工作日内安排发货。'
      }
    ],
    imgArr: [{
      id: 1,
