...
Page({
  ...
  getRule() { //获取规则
    ...
    wx.request({
      ...
      success: function(res) {
        let str ="说明：本活动的核心，是联合万达风味美食季，以投票的形式选出湖北万达十大招牌菜;[]1. 活动主体分单品菜评选、商家评选，共两个独立赛场;[]2.	单品菜评选将在投票截止时间（2019年02月27日24点整），根据每个商家活动招牌菜的总票数决定名次（最终获奖方为提供单品菜的商家）;[]3.	商家评选共设最黑马、最潜力两个奖项，由享7团队根据限定时间内人气、票数增长等标准综合评定;[]4.	本场活动，为单个菜品投票数无上限，每天获得的票数若不消耗不可累计。获取票的方式如下：登录：每个账号每天进入小程序即可获得1票，可投给任意活动菜品消费：消费活动单品菜（券），每笔消费可获得5票，自动投给本次消费活动菜品;[]5.	本场活动，每日净增票数增长最多的前3名单品菜，平台将于次日各增加100票，不计入次日净增票数，但计入活动结束后单品菜总票数;[]6.	本场活动，榜单每1分钟刷新一次最新得票数据情况;[]7.	活动最终解释权归享7购所有";
        console.log("str:", str)
        let data = res.data.data;
        that.setData({
